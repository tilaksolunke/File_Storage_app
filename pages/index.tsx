...
export default function Home() {
  ...
  const Publishible_Key="pk_test_cGlja2VkLWtvaS01MC5jbGVyay5hY2NvdW50cy5kZXYk"
        ...
        <div className="w-full h-full m-auto bg-heroImage bg-cover bg-center flex flex-col justify-center items-center">
          <div className="h-full max-w-screen-xl">
            ...
            <div className="h-full w-full  m-auto flex justify-center items-center gap-8">
              ...
              <h1 className="text-4xl font-bold text-purple-700 transform hover:rotate-3 transition-transform duration-300 shadow-md">Open Storage</h1>


                <p>
    Welcome to File Storage App! This app allows you to securely store and manage your files in IPFS (InterPlanetary File System), ensuring data integrity and accessibility. To get started, sign up and log in to your account. Upload your files with confidence, knowing that they are stored in a decentralized and reliable manner.
</p>
              ...
              <div className="w-1/2 flex justify-center items-center h-full">
                <Image height={600} width={600} src="/gogo.png" alt="hero image of computer and code" />
              </div>
            </div>
          </div>
          <div className="h-full w-full bg-secondary">
            <div className="max-w-screen-xl min-h-full my-8 mx-auto flex justify-center items-center gap-8">l
              <div className="text-center bg-light rounded-lg w-full flex flex-col justify-center items-center p-2 gap-4 h-[475px]">
                <Image
                  ...
                  width="200"
                />
                <h2 className="font-telegraf font-bold text-3xl">IPFS SITE</h2>
                <p className="w-2/3">
                "Explore on IPFS: Click here to access the content on the InterPlanetary File System (IPFS), a decentralized network protocol for storing and sharing data in a secure and distributed manner."
                </p>
                <a
          ...
          <div className="bg-accent w-full h-full">
            <div className="max-w-screen-xl mx-auto py-6 flex justify-between items-center text-light">
              <p className="text-xs">Copyright © 2024 Grp_74 | All Rights Reserved </p>
